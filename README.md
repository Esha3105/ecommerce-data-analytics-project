...
- Order details
- Ratings, discounts, device type, and city

---

# Key Analysis Performed-
- Data cleaning & feature engineering (Age Group, Month, Year)
...
- Revenue heavily depends on returning customers **(~93% retention)**
- Electronics dominates revenue → dependency risk
